...
st.write("This app uses machine learning in order to predict house prices using multiple features")
...
if predictbutton:
    ...
    st.write("Please use predict button after entering the values")
